...
const Contact = () => {
  return (
    <>
      <div className='bg-red-400 w-screen h-fit'>
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div class="sm:col-span-2">
                ...
                <div class="relative mt-2.5">
                  ...
                  <input type="tel" name="phone-number" id="phone-number" autocomplete="tel" class="block pl-[7rem] w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              </div>
              <div class="sm:col-span-2">
